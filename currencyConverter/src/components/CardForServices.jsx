...
const CardForServices = ({ img, title, para, strikethrough, serial }) => {
  return (
    <div
      className="flex flex-col justify-between items-center text-center p-4 relative bg-black text-gray-300 hover:bg-[#2D2D2D] hover:text-white transition-colors duration-700"
    >
      ...
      <br />
      <div className="w-full h-[3px] bg-[#2D2D2D]  hover:bg-orange-500"></div>
    </div>
  )
}
